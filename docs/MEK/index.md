...
![图片 12](./Images/Index/图片12.png)

![图片 13](./Images/Index/图片13.png)

水源使用水槽，配合机械管道抽水，加入到电解分离器

![图片 14](./Images/Index/图片14.png)

电解分离器产生氢气，可以和加压反应室共用水源。

![图片 15](./Images/Index/图片15.png)

![图片 16](./Images/Index/图片16.png)

氢气和水到位后，投入生物燃料即可产出乙烯（气体），产生的基片需要另外收集。

![图片 17](./Images/Index/图片17.png)

然后通过加压管道将乙烯输入燃气发电机进行发电。

![图片 18](./Images/Index/图片18.png)

导出电力，可以重新用于发电系统中的其它机器。不要忘记放上能量立方进行存电。

![图片 19](./Images/Index/图片19.png)
